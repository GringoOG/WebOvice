(() => {
  ...
  const dict = {
    cs: {
      ...
      "pricing.web.scope": "Firemní weby • landing pages • rezervace • e-learning",
      "pricing.web.cta": "Chci nový web",
      "pricing.mkt.title": "Online marketing",
      "pricing.mkt.price": "od 4&nbsp;000&nbsp;Kč",
      "pricing.mkt.scope": "Google Ads • Meta • SEO • obsah • analytika",
    ...
    en: {
      ...
      "pricing.web.scope": "Business sites • landing pages • booking • e-learning",
      "pricing.web.cta": "I want a new website",
      "pricing.mkt.title": "Online marketing",
      "pricing.mkt.price": "from CZK&nbsp;4,000",
      "pricing.mkt.scope": "Google Ads • Meta • SEO • content • analytics",
