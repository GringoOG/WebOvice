(() => {
  ...
  const dict = {
    cs: {
      ...
      "works.item6.statValue": "Vlastní",
      "works.item6.stat": "rezervační systém",
      ...
      "refs.2.quote":
        "„Online školení i <strong>automatické certifikáty</strong> máme na jednom místě. Web vypadá profesionálně a obsah aktualizujeme sami — snadno a rychle, bez čekání na vývojáře.\"",
      ...
      "refs.6.quote":
        "„Máme vlastní <strong>rezervační systém</strong> přímo na webu — hosté bookují u nás a my platíme méně bookingovým platformám. Přesně to jsme potřebovali.\"",
    ...
    en: {
      ...
      "works.item6.statValue": "Built-in",
      "works.item6.stat": "booking system",
      ...
      "refs.2.quote":
        "“Online training and <strong>automatic certificates</strong> in one place. The site looks professional and we update content ourselves — easy and fast, without waiting on a developer.”",
      "refs.2.name": "Karel Hrbek",
      ...
      "refs.6.quote":
        "“We have our own <strong>reservation system</strong> right on the website — guests book with us and we pay less to booking platforms. Exactly what we needed.”",
      "refs.6.name": "AndeStay Hostel",
