(() => {
  ...
  const dict = {
    cs: {
      ...
      "a11y.stack.deck": "Tech stack — klepnutím nebo najetím rozbalíte",
      ...
      "hero.quotes.1.text": "Web online za pár dnů, moderně a bez starostí.",
      "hero.quotes.1.author": "Klient — firemní web",
      "hero.quotes.2.text": "Bez halucinací AI — data rovnou v Excelu.",
      ...
      "hero.quotes.4.text": "Web s rezervačním systémem za 2 týdny.",
      "hero.quotes.4.author": "Klient — hotelový web",
      "hero.quotes.5.text": "Konec starostí s termíny a certifikáty.",
      "hero.quotes.5.author": "Klient — Sofisticator",
      ...
      "contact.form.phone": "Telefonní číslo (volitelně)",
    ...
    en: {
      ...
      "a11y.stack.deck": "Tech stack — tap or hover to expand",
      ...
      "hero.quotes.1.text": "Website online in a few days — modern and worry-free.",
      "hero.quotes.1.author": "Client — company website",
      "hero.quotes.2.text": "No AI hallucinations — data straight into Excel.",
      ...
      "hero.quotes.4.text": "Website with a booking system in 2 weeks.",
      "hero.quotes.4.author": "Client — hotel website",
      "hero.quotes.5.text": "No more worrying about deadlines and certificates.",
      "hero.quotes.5.author": "Client — Sofisticator",
